...
def _build_parser() -> argparse.ArgumentParser:
    p = argparse.ArgumentParser(description="Convert Excel workbooks (.xlsx, .xlsm) or .csv to Markdown.")
    p.add_argument("-i", "--input", required=True, type=Path, help="Path to .xlsx, .xlsm, or .csv file")
