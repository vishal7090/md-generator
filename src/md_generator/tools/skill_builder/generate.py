...
from .pyproject_util import parse_project_version_and_scripts, scripts_by_area
from .routing import AREA_SKILL_IDS, build_routing_block
...
def _sync_sdk_data_bundle(repo_root: Path, ai_root: Path) -> None:
    """Copy distributable `ai/` artifacts into md_generator.tools.assistant package data."""
    pkg_root = repo_root / "src" / "md_generator" / "tools" / "assistant"
