...
class LogApiSettings(BaseSettings):
    ...
    max_log_upload_mb: int = 256


def cors_list(settings: LogApiSettings) -> list[str]:
...
def sqlite_path_resolved(settings: LogApiSettings) -> Path | None:
